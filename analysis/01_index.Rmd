...
Software: 
  * Trimmomatic/Kraken2
  * Bowtie2/IGC
  * Biobakery3::Metaphlan/HUMANN/ChocophlanDB
...
(Details on sample collection, shipment, DNA extraction)
Extracted DNA was submitted to Macrogen(Macrogen, South Korea) for sequencing, with a median depth of 10 million reads 150x2 in paired-end configuration.
...
- When possible, Analysis results have been packaged into phyloseq object for further analysis.
...
myMREObject@taxa@metaphlan@phyloseq %>% saveRDS(object=.,file="data/ps_metaphlan_feces.rds")
myMREObject@taxa@metaphlan@phyloseq_sec %>% saveRDS(object=.,file="data/processed/ps_metaphlan_feces_sec.rds")
...
myMREObject@taxa@metaphlan@phyloseq %>% saveRDS(object=.,file="data/processed/ps_metaphlan_goal1.rds")
myMREObject@taxa@metaphlan@phyloseq_sec %>% saveRDS(object=.,file="data/processed/ps_metaphlan_goal1_sec.rds")
...
myMREObject@taxa@metaphlan@phyloseq %>% saveRDS(object=.,file="data/processed/ps_metaphlan_goal2.rds")
myMREObject@taxa@metaphlan@phyloseq_sec %>% saveRDS(object=.,file="data/processed/ps_metaphlan_goal2_sec.rds")
### Dataset for goal3
myMREObject<-readRDS("data/processed/mreObject.rds")
aux_DF<-table(metadata_df %>% 
               dplyr::select(Host_name,Timepoint)) %>% 
...
myMREObject@taxa@metaphlan@phyloseq %>% saveRDS(object=.,file="data/processed/ps_metaphlan_goal3.rds")
myMREObject@taxa@metaphlan@phyloseq_sec %>% saveRDS(object=.,file="data/processed/ps_metaphlan_goal3_sec.rds")
```
